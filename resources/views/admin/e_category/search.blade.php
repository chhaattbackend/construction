    ...
    <div class="card-tools">
        <div class="input-group input-group-sm" style="width: 335px;">
            ...
            <div class="input-group-append">
                ...
                <a href="{{ route('ecategories.create') }}"><button class="btn btn-primary">Add
                        Category</button></a>
            </div>
        </div>
    </div>
        ...
        <tbody>
            @forelse ($ecategories as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('ecategories.edit', $item->id) }}" class="float-left"><i
                                class="fas fa-edit"></i></a>
                        <form action="{{ route('ecategories.destroy', $item->id) }}" method="POST">
...
<div class="align-right paginationstyle">
    @if($keyword !== null)
    {{ $ecategories->appends($keyword)->links() }}
@else
    {{ $ecategories->links() }}
@endif
</div>
