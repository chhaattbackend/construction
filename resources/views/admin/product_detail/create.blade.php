        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- form start -->
                    <div class="col-md-8">
                        <form action="{{ route('productdetails.store') }}" method="POST" class="form-horizontal"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" row="3">
                                        <textarea required class="form-control" name="overview" rows="6"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" row="3">
                                        <textarea required class="form-control" name="description" rows="6"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" row="3">
                                        <textarea required class="form-control" name="specification" rows="6"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
