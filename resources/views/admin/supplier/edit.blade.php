                        ...
                        <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST" class="form-horizontal"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-6">
                                        <select required name="user_id" class="form-control" id="user_id">
                                            ...
                                            @forelse ($users as $item)
                                                <option @if ($item->id == $supplier->user_id) selected @endif value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @empty
                                    ...
                                    <div class="col-sm-6">
                                        <select required name="store_id" class="form-control" id="store_id">
                                            ...
                                            @forelse ($stores as $item)
                                                <option @if ($item->id == $supplier->store_id) selected @endif value="{{ $item->id }}">
                                                    {{ $item->name }}</option>
                                            @empty
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" value="{{ $suppliers->name }}" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" value="{{ $suppliers->email }}" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" value="{{ $suppliers->contact }}" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" value="{{ $suppliers->nic }}" class="form-control"
