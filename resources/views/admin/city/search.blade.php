    ...
    <div class="card-tools">
        <div class="input-group input-group-sm" style="width: 335px;">
            ...
            <div class="input-group-append">
                ...
                <a href="{{ route('cities.create') }}"><button class="btn btn-primary">Add
                        Category</button></a>
            </div>
        </div>
    </div>
        ...
        <tbody>
            @forelse ($cities as $item)
                <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td>
                        <a href="{{ route('cities.edit', $item->id) }}" class="float-left"><i class="fas fa-edit"></i></a>
