    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-info">
                ...
                <div class="col-md-8">
                    <form action="{{ route('productimages.update', $product->id) }}" method="POST"
                                    ...
                                    <tbody>
                                        @foreach ($product->images as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="form-img"
                                                        src="https://chhatt.s3.ap-south-1.amazonaws.com/construction/product/{{ $item->name }}">

                                                </td>
                                                <td>
                                                    <a href="{{ route('productimages.delete', $item->id) }}"
